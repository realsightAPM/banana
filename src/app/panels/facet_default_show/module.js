...
define([
  ...
  function(angular, app, _, kbn) {
    ...
    module.controller('facet_default_show', function($rootScope, $scope, fields, querySrv, dashboard, filterSrv) {
      ...
      $scope.facet_label = function(key) {
        ...
        return filterSrv.translateLanguageKey("facet_default_show", key, dashboard.current);
      };
