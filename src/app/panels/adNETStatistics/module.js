...
define([
    ...
    function (angular, app, _, $, kbn) {
        ...
        var DEBUG = false;
        console.log('adNETStatistics DEBUG : ' + DEBUG);

        var module = angular.module('kibana.panels.adNETStatistics', ['smart-table']);
        app.useModule(module);

        module.controller('adNETStatistics', function($scope, $timeout, $filter, timer, querySrv, dashboard, filterSrv) {
            $scope.panelMeta = {
                exportfile: true,
                editorTabs : [
            ...
            $scope.build_query = function(filetype, isForExport) {
              ...
              if (DEBUG) { console.log(dashboard.current); }
              if (DEBUG) { console.log(fq); }
              if (DEBUG) { console.log((dashboard.current.ad_start_timestamp && dashboard.current.ad_end_timestamp));}
              if (DEBUG) { console.log((dashboard.current.ad_start_timestamp + ' ' + dashboard.current.ad_end_timestamp));}
              ...
              facet += '&facet.sort=' + ($scope.panel.sortBy || 'count');
