...
function (angular, app, $, _, kbn, moment, timeSeries) {
  ...
  module.controller('donetstacking', function($scope, $translate,$q, querySrv, dashboard, filterSrv) {
    $scope.panelMeta = {
    ...
    var _d = {
	  ...
	  value_field : 'DOTNET_Requests_Queued DOTNET_Requests_Rejected DOTNET_Errors_Total DOTNET_Gen_0_Collections DOTNET_Gen_1_Collections DOTNET_Gen_2_Collections',
   ...
   module.directive('donetstackingChart', function(querySrv,dashboard,filterSrv) {
    return {
      restrict: 'A',
      link: function(scope, elem) {
        ...
        function render_panel() {
          ...
          for (var i =0;i<chartData[0].length;i++){
            ...
            redirectElapsed[i] = chartData[0][i].DOTNET_Requests_Queued;
            cacheElapsed[i] = chartData[0][i].DOTNET_Requests_Rejected;
            loadEventElapsed[i] = chartData[0][i].DOTNET_Errors_Total;
            dnsElapsed[i] = chartData[0][i].DOTNET_Gen_0_Collections;
            user_cpu[i] = chartData[0][i].DOTNET_Gen_1_Collections;
            sys_cpu[i] = chartData[0][i].DOTNET_Gen_2_Collections;
