...
function (angular, app, $, _, kbn, moment, timeSeries) {
  ...
  module.controller('threadhistobar', function($scope,$translate, $q, querySrv, dashboard, filterSrv) {
    var _d;
      $scope.panelMeta = {
   ...
   module.directive('threadhistobarChart', function( querySrv,dashboard,filterSrv) {
    return {
      restrict: 'A',
    ...
    tooltip : {
        ...
        formatter: function(params) {
            ...
            if(scope.panel.another){
               res =  "Name: "+params[0].data.name+'<br/>'+"State: "+myWarn+'<br/>'+"value: "+warn+'<br/>'+"Time: "+params[0].name;
            }else {
               res = "Name: " + params[0].data.name + '<br/>' + "State: " + myWarn+'<br/>'+"Time: "+params[0].name;
            }
            return res;
        },
    },
