          ...
          require(['echarts'], function (ec) {
            ...
            if (scope.panel.chart === 'pie') {
              ...
              if (scope.data.length == 0) {
                myChart1.setOption(option_nodata);
              } else {
            ...
            if (scope.panel.chart === 'rosepie') {
              ...
              if (scope.data.length == 0) {
                myChart2.setOption(option_nodata);
              } else {
            ...
            if (scope.panel.chart === 'bar') {
              ...
              if (scope.data.length == 0) {
                myChart3.setOption(option_nodata);
              } else {
            ...
            if (scope.panel.chart === 'horizontalBar') {
              ...
              if (scope.data.length == 0) {
                myChart33.setOption(option_nodata);
              } else {
            ...
            if (scope.panel.chart === 'radar') {
              ...
              if (scope.data.length == 0) {
                myChart4.setOption(option_nodata);
              } else {
            ...
            if (scope.panel.chart === 'bars') {
              ...
              if (scope.data.length == 0) {
                myChart5.setOption(option_nodata);
              } else {
            ...
            if (scope.panel.chart === 'funnel') {
              ...
              if (scope.data.length == 0) {
                myChart6.setOption(option_nodata);
              } else {
            ...
            if (scope.panel.chart === 'ebar') {
              ...
              // 使用刚指定的配置项和数据显示图表。
              if (scope.data.length == 0) {
                myChart7.setOption(option_nodata);
              } else {
            ...
            if (scope.panel.chart === 'liquidfill') {
              ...
              // 使用刚指定的配置项和数据显示图表。
              if (scope.data.length == 0) {
                myChart8.setOption(option_nodata);
              } else {
                myChart8.setOption({
                  tooltip: {
                    show: true,
