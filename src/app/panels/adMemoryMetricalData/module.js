...
define([
  ...
  function (angular, app, _, $, kbn) {
    'use strict';
    var DEBUG = true;
    console.log('adMemoryMetricalData DEBUG : ' + DEBUG);

    var module = angular.module('kibana.panels.adMemoryMetricalData', []);
    app.useModule(module);

    module.controller('adMemoryMetricalData', function($scope, $timeout, $filter, $routeParams, timer, querySrv, dashboard, filterSrv) {
      $scope.panelMeta = {
          exportfile: true,
          editorTabs : [
      ...
      $scope.build_query = function(filetype) {
        // Build Solr query
        var fq = '&fq=result_s:jm_memory_ad';
    ...
    module.directive('memoryMetricalData', function(querySrv,dashboard,filterSrv) {
      return {
        restrict: 'A',
            ...
            require(['echarts'], function (ec) {
              ...
              myChart.on('click', function (params){
                if (params.componentType === 'markPoint') {
                  ...
                  path += '&memoryid=' + params.data.id;
                  path += '&threadid=' + scope.threadid;
                  if (DEBUG) console.log(path);
                  if (DEBUG) console.log(params.data.id);
                  if (DEBUG) console.log(scope.threadid);
                  scope.toUrl(path);
                }
              });
            });
