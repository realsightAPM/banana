...
function (angular, app, _, $, kbn) {
  ...
  module.controller('topology', function($scope, $timeout, $translate,timer, querySrv, dashboard, filterSrv) {
    $scope.panelMeta = {
      exportfile: true,
      editorTabs : [
    ...
    return {
      ...
      link: function(scope, elem) {
        ...
        function render_panel() {
          ...
          getJSON('http://10.0.67.14:28080/getServerMapData.pinpoint?applicationName=test123&from=1499838187000&to=1499838487000&callerRange=1&calleeRange=1&serviceTypeName=TOMCAT&_=1499838447935').then(function(data) {
                    var aaa= data;
                 });
