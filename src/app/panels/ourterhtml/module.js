...
function (angular, app, _, $, kbn) {
  ...
  var module = angular.module('kibana.panels.ourterhtml', []);
  app.useModule(module);

  module.controller('ourterhtml', function($scope, $timeout, $translate,timer, querySrv, dashboard, filterSrv) {
    $scope.panelMeta = {
      exportfile: true,
      editorTabs : [
  ...
  module.directive('ourterhtmlChart', function(querySrv,dashboard,filterSrv) {
    return {
      restrict: 'A',
