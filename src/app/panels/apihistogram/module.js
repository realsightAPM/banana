...
function (angular, app, $, _, kbn, moment, timeSeries) {
  ...
  module.controller('apihistogram', function($scope, $translate,$q, querySrv, dashboard, filterSrv) {
    $scope.panelMeta = {
   ...
   module.directive('apihistogramChart', function(dashboard, filterSrv) {
    return {
      restrict: 'A',
      template: '<div></div>',
